<template>
  <footer class="font-[Sarabun] bg-[#801810] py-6 px-8 tracking-wide mt-4">
    <div class="relative max-w-screen-xl mx-auto">
      <div class="bg-[#ffffff] rounded-b-lg gap-3 rounded-md shadow-2xl flex flex-wrap items-center justify-between sm:px-8 max-sm:px-4 py-5 absolute top-[-66px] w-full">
        ...
        <button type='button' class="px-4 py-2 text-[15px] font-semibold rounded-full text-[#ffffff] gap-2 bg-[#801810] cursor-pointer">สํานักงานคณะกรรมการการอาชีวศึกษา</button>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-15 px-4 rounded-b-md bg-[#801810]">
          ...
          <div class="lg:col-span-1 max-w-md">
              ...
              <hr class="w-54 bg-gray-100 border-spacing-x-0.5 text-white rounded-sm dark:bg-gray-700 mb-4">
          </div>
